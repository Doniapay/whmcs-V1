...
function doniapay_payment_url($params){
    ...
    $success_url = $systemUrl . '/modules/gateways/callback/doniapay.php?api='.$apikey.'&secret='.$secretkey.'&host='.$hostname.'&invoice='.$invoiceId;
    ...
    $header   = array(
        ...
        "secret"            => $secretkey,
        "position"          => $hostname,
        "url"               => 'https://pay.doniapay.com/request/payment/create',
    );
